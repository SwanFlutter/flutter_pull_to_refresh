...
import 'package:flutter_pull_to_refresh/src/internals/refresh_localizations.dart';
...
class _WaterDropHeaderState extends RefreshIndicatorState<WaterDropHeader> with TickerProviderStateMixin {
  ...
  @override
  void initState() {
    _dismissCtl = AnimationController(vsync: this, duration: const Duration(milliseconds: 400), value: 1.0);
            ...
            child: Stack(
              children: <Widget>[
                ...
                Container(
                  ...
                  margin: Scrollable.of(context).axisDirection == AxisDirection.up ? const EdgeInsets.only(bottom: 12.0) : const EdgeInsets.only(top: 12.0),

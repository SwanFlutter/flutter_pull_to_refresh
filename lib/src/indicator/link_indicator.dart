...
class LinkHeader extends RefreshIndicator {
  ...
  const LinkHeader({super.key, required this.linkKey, super.height = 0.0, RefreshStyle? super.refreshStyle, super.completeDuration = const Duration(milliseconds: 200)});
...
class LinkFooter extends LoadIndicator {
  ...
  const LinkFooter({super.key, required this.linkKey, super.height = 0.0, LoadStyle super.loadStyle = LoadStyle.showAlways});
